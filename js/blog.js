    ...
    [
        {
           ...
           "operating_hours": {
            ...
            "updatedAt": "2020-04-28T13:51:46.198Z",
            "id": 1,
            "is_favorite": "false"
        },
        {
            ...
            "updatedAt": "2020-08-10T20:55:27.787Z",
            "is_favorite": "true",
            "id": 2
        },
        {
...
console.log(data[0].operating_hours)
    console.log(Object.values(data[0].operating_hours)[0])
    function displayObject() {
        data.forEach(function (item) {
            for (let i = 0; i < Object.keys(item.operating_hours).length; i++) {
                $('#posts').append("<div><div>" + Object.keys(item.operating_hours)[i] + "</div><div>" + Object.values(item.operating_hours)[i] +"</div></div><br>")
            }
